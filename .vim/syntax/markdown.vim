...
" Todo:
syn match pandocTodo /TODO\|NOTE/

" Linebreak:
syn match pandocLinebreak /^=\+$/

" Inline Code:
" Using single back ticks
" syn region pandocNoFormatted start=/`/ end=/`\|^\s*$/ contained
syn region pandocNoFormatted start=/`/ end=/`/ contained
...
syn match pandocListItem /^\s*(*[\u\U][.)]\+\s\{2,}/he=e-1 nextgroup=pandocPara
syn match pandocListItem /^\s*(*[#IVXC]*[.)]\+\s\{1,}/he=e-1 nextgroup=pandocPara
...
hi link pandocLinebreak                  Identifier
